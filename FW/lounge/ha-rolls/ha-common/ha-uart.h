...
typedef struct ha_uart_s {
    ...
    // tx_len & read index are atomic - protection required!
	uint8_t tx_rd_idx;              // ISR R/W; IDLE R/W  - cli/sei protected
	uint8_t tx_len;                 // ISR R/W; IDLE R/W  - cli/sei protected
} ha_uart_t;
